...
public class Derived_DataCore<FieldType, ContainerType extends DataObject> extends DataCore<FieldType> {
    ...
    public static class Derived_DataCore_Factory<FieldType, ContainerType extends DataObject> extends DataCore_Factory<FieldType, Derived_DataCore<FieldType, ContainerType>> {
         ...
         */
        private final DirectExternal_Source.DirectExternalSource_Factory<FieldType, ContainerType> sourceFactory;
         ...
         */
        private final Source.Source_Factory<FieldType, ?>[] sources;

        /**
         * Constructor
         */
        public Derived_DataCore_Factory(Calculator<FieldType, ContainerType> calculator, Source.Source_Factory<FieldType, ?>... sources) {
         ...
         * Constructor
         */
        public Derived_DataCore_Factory(DirectExternal_Source.DirectExternalSource_Factory<FieldType, ContainerType> sourceFactory) {
        ...
        public Derived_DataCore<FieldType, ContainerType> createCore(DataField<FieldType> container) {
            if (sourceFactory != null) {
                ...
                int i = 0;
                for (Source.Source_Factory<FieldType, ?> factory : sources) {
     ...
     * Constructor
     */
    public Derived_DataCore(DirectExternal_Source<FieldType, ContainerType> source) {
    ...
    public Derived_DataCore(Calculator<FieldType, ContainerType> calculator, Source<FieldType>... sources) {
        ...
        for (Source<FieldType> source : sources) {
            if (source instanceof DirectExternal_Source) {
                if (sources.length != 1) {
