 ...
 */
public class External_Source<ResultType, SourceContainerType extends DataObject, SourceType> extends Source<ResultType> implements FieldChangeListener<SourceType> {

    //------------------------------------------------------------------------------------------------------------------
    //##################################################### Factory ####################################################
    //------------------------------------------------------------------------------------------------------------------

    public static class ExternalSource_Factory<ResultType, SourceContainerType extends DataObject, SourceType> extends Source_Factory<ResultType, External_Source<ResultType, SourceContainerType, SourceType>> {
        ...
        public External_Source<ResultType, SourceContainerType, SourceType> createSource(DataField<ResultType> container) {
            return new External_Source<>(container.getContainer().getField(sourceContainerFieldKey), sourceFieldName);
        }
    }
     ...
     * Constructor
     */
    public External_Source(DataField<SourceContainerType> sourceContainerField, String sourceFieldName) {
