...
public class ListDataField_Instance<T> extends DataField_Instance<List<T>>{

    /**
     * Constructor
     */
    public ListDataField_Instance(DataField<List<T>> dataField, DataObject container) {
    ...
    public void add(T toAdd) {
        if (getDataField().getSourceMode().equals(DataField.SourceMode.DERIVED))
    ...
    void addFromDataCore(T toAdd) {
        if (getDataField().getSourceMode().equals(DataField.SourceMode.DIRECT))
